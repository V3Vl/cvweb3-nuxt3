      ...
      <div v-show="state.loginType === 'test'">
        ...
        <div m="0 auto" w="80" class="test-login">
          <a-form :model="formState" name="normal_login" class="login-form" @finish="onFinish"
            ...
            <a-form-item v-show="state.isLogin === false" label="Nickname" name="nickname" :rules="[
            ...
            <!-- 验证码 -->
            <a-form-item v-show="state.isLogin === false" name="password" :rules="[
              { required: true, message: 'Please input your password!' },
            ]">
              <a-input-group compact>
                <a-input v-model:value="formState.code" style="float: left; width: 60%" />
                <a-button type="primary" @click="getCode"
                  :disabled="isDisable">{{ isDisable ? `${countDown}s后重新获取` : '获取验证码' }}</a-button>
              </a-input-group>
            </a-form-item>
            ...
            <a-form-item>
              <a-button v-show="state.isLogin" :disabled="disabled" type="primary" html-type="submit"
                class="login-form-button">
                Log in
              </a-button>
              <a-button v-show="state.isLogin === false" :disabled="disabled" type="primary" html-type="submit"
                class="login-form-button" @click="registerBtn">
                Register
              </a-button>
